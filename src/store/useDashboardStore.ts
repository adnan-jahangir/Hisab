...
export const useDashboardStore = create<DashboardStore>((set) => ({
  ...
  recalculate: () => {
    ...
    // Revenue & Gross Profit calculations
    const currentRevenue = salesStore.getTotalRevenue(startOfMonth);
    const grossProfit = salesStore.getTotalProfit(startOfMonth);
    ...
    // Accurate Net Profit: Gross Profit (Revenue minus Buying Cost) minus Operational Expenses
